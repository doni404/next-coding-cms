    ...
    <div className='customizer'>
      ...
      <Drawer open={open} hideBackdrop anchor='right' variant='persistent'>
        ...
        >
          ...
          <Typography sx={{ color: 'text.secondary' }}>リアルタイムでカスタマイズ＆プレビュー</Typography>
          <IconButton
          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                ...
                <FormControlLabel value='bordered' label='ボーダー' control={<Radio />} />
            ...
            <Box>
              <Typography sx={{ mb: 2.5 }}>基本色</Typography>
              <Box sx={{ display: 'flex' }}>
                <ColorBox
                  onClick={() => handleChange('themeColor', 'ensfr')}
                  sx={{
                    ml: 0,
                    backgroundColor: '#122b4f',
                    ...(themeColor === 'ensfr' ? { boxShadow: 9 } : { '&:hover': { boxShadow: 4 } })
                  }}
                >
                  {themeColor === 'ensfr' ? <Check fontSize='small' /> : null}
                </ColorBox>
                <ColorBox
          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <RadioGroup
                ...
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
                <FormControlLabel value='full' label='全体' control={<Radio />} />
                <FormControlLabel value='boxed' label='囲み' control={<Radio />} />
              </RadioGroup>
            </Box>

            <Box sx={{ mb: 4 }}>
              <Typography>AppBarタイプ</Typography>
              <RadioGroup
                row
                value={appBar}
              ...
              >
                ...
                {layout === 'horizontal' ? null : (
                  <FormControlLabel value='hidden' label='隠す' control={<Radio />} />
                )}
              </RadioGroup>
            </Box>

            <Box sx={{ mb: 4 }}>
              <Typography>フッタ</Typography>
              <RadioGroup
                row
                value={footer}
            ...
            <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <Typography>AppBarぼかし</Typography>
              <Switch
                name='appBarBlur'
                checked={appBarBlur}
          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            <Box sx={{ mb: layout === 'horizontal' && appBar === 'hidden' ? {} : 4 }}>
              ...
              <RadioGroup
                ...
                sx={{ '& .MuiFormControlLabel-label': { fontSize: '.875rem', color: 'text.secondary' } }}
              >
                <FormControlLabel value='vertical' label='縦' control={<Radio />} />
                <FormControlLabel value='horizontal' label='横' control={<Radio />} />
              </RadioGroup>
            </Box>

            {navHidden || layout === 'horizontal' ? null : (
              <Box sx={{ mb: 4 }}>
                <Typography>トグル</Typography>
                <RadioGroup
                  row
                ...
                >
                  ...
                  <FormControlLabel value='collapse' label='折り畳み' control={<Radio />} />
                </RadioGroup>
              </Box>
            )}
            ...
            {navHidden || layout === 'horizontal' ? null : (
              <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Typography>メニュー折り畳み</Typography>
                <Switch
                  name='navCollapsed'
