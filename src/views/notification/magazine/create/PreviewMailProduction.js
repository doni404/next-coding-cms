...
const GetNewsImage = (news) => {
  ...
  if (news.news != "") {
    return <img
      src={BASE_URL_API + "v1/public/resources?type=news&filename=" + news.news}
      alt="workshop"
...
const GetArticleImage = (article) => {
  ...
  if (article.article != "") {
    return <img
      src={BASE_URL_API + "v1/public/resources?type=articles&filename=" + article.article}
      alt="workshop"
      onerror="this.src='../resources/images/no_photo.jpg';"
      style={style.imageRankAsset}
    />
    ...
    return <img
      src="https://dev-api.art-with.me/v1/public/resources?type=articles&filename=2022-10-11_10:26:56.png"
      alt="workshop"
      onerror="this.src='../resources/images/no_photo.jpg';"
      style={style.imageRankAsset}
    />
...
const GetAssetImage = (asset) => {
  ...
  if (asset.asset != "") {
    return <img
      src={BASE_URL_API + "v1/public/resources?type=assets&filename=" + asset.asset}
      alt="workshop"
      onerror="this.src='../resources/images/no_photo.jpg'"
      style={style.imageRankAsset}
    />
...
function PreviewMailProduction(data) {
...
export default PreviewMailProduction;