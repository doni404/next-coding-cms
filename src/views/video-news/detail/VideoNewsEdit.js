...
// ** Store Imports
import { updateVideoNews, deleteVideoNews } from "src/store/apps/video_news";
...
const VideoNewsEdit = ({ setRefreshKey, data, id }) => {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(updateVideoNews({ id, data }))
      .unwrap()
