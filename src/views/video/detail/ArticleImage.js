...
import ArticleImageListTable from "./ArticleImageListTable";

import { addArticleImage } from 'src/store/apps/article_image' 


const ArticleImage = ({  data, id }) => {
  // ** Hooks
  ...
  const onSubmit = (e) => {
    ...
    if (imgSrc != "") {
      dispatch(addArticleImage({ ...request }))
  ...
  return (
    <Box sx={{ p: 5, pb: 10 }}>
      ...
      <ArticleImageListTable article_id={id} />
    </Box>
  );
};
